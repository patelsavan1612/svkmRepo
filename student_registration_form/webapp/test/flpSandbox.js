		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#studentregistrationform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentregistrationform-display": {
								"semanticObject": "studentregistrationform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=studentregistrationform",
									"url": sap.ui.require.toUrl("studentregistrationform")
								}
							}
						}
					}
