		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "External Company Access Placement Report",
									"targetURL": "#companyaccessreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"companyaccessreport-display": {
								"semanticObject": "companyaccessreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=companyaccessreport",
									"url": sap.ui.require.toUrl("companyaccessreport")
								}
							}
						}
					}
