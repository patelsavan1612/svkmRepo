		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Update Candidate’s Placement Status",
									"targetURL": "#updatestatusreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"updatestatusreport-display": {
								"semanticObject": "updatestatusreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=updatestatusreport",
									"url": sap.ui.require.toUrl("updatestatusreport")
								}
							}
						}
					}
