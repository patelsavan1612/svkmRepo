		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#studentprofilereport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentprofilereport-display": {
								"semanticObject": "studentprofilereport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=studentprofilereport",
									"url": sap.ui.require.toUrl("studentprofilereport")
								}
							}
						}
					}
